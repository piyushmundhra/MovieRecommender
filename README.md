...
## Diagram 
 ...
 >   * Next, we had to test our getUserRecs() functionality for Options2. This derived class specifies that it will only give recommendations up to the number of movies the user liked.
